...
class Meta:
    def __init__(self):
        ...
        self.cfd_A = VariableMeta(
            ...
            unit='kWhEE/m²GF', 
            comment='Konventionelle Stahlbeton-Bauweise mit fossilen Dämmstoffen. Wärmeschutz: 3/3 (Passivhaus)', 
            source='IN', 
            ka=1, 
            domain='declaration', 
            measure='A', 
        ...
        self.cfd_dx = VariableMeta(
            ...
            attr_name='cfd_dx', 
            icon='🔧', 
            label_de='Eingeschoßiges EFH (Baujahr bis 1944)', 
            unit='-', 
            comment='Neubau', 
            source='IN', 
            ka=1, 
        ...
        self.project_name = VariableMeta(
            ...
            icon='137.184', 
            label_de='2.5157142947006443', 
            unit='text', 
            comment='STB-Geschossdecke - Distanzboden', 
            source='IN', 
            ka=2, 
            domain='project', 
            measure='name', 
        ...
        self.project_url = VariableMeta(
            ...
            label_de='2.5157142947006443', 
            unit='text', 
            comment='DAl 06 a Leichtbau-Terrasse, hinterlüftet', 
            source='IN', 
            ka=2, 
            domain='project', 
            measure='url', 
        ...
        self.location_address = VariableMeta(
            ...
            label_de='2.5157142947006443', 
            unit='text', 
            comment='Beton massiv Kellerdecke/Fundamentplatte', 
            source='IN', 
            ka=2, 
            domain='project', 
            measure='address', 
        ...
        self.project_creation_date = VariableMeta(
            ...
            unit='date', 
            comment='ADh 01 b Massivholzdecke über Außenluft, Nassestrich', 
            source='IN', 
            ka=2, 
            domain='project', 
            measure='created', 
        ...
        self.project_description = VariableMeta(
            ...
            unit='text', 
            comment='EAm 04 Erdberührte Ziegel-Außenwand', 
            source='IN', 
            ka=2, 
            domain='project', 
            measure='description', 
        ...
        self.project_scenario_name = VariableMeta(
            ...
            unit='text', 
            comment='IWm 04 a Vollziegel-Scheidewand, unverputzt', 
            source='IN', 
            ka=2, 
            domain='project', 
        ...
        self.location_postcode = VariableMeta(
            ...
            icon='112.66235999999999', 
            label_de='Postleitzahl', 
            unit='text', 
            comment='IWl 03 b Leichtbau-Wohnungstrennwand, tragend o. Vorsatzschale', 
            source='IN', 
            ka=2, 
            domain='project', 
            measure='postcode', 
        ...
        self.weather_index = VariableMeta(
            ...
            label_de='0', 
            unit='int', 
            comment='Fenster Passivhaus (35% Rahmenanteil)', 
            source='IN', 
            ka=0, 
            domain='weather', 
            measure='index', 
        ...
        self.GFA_residential = VariableMeta(
            ...
            label_de='0', 
            unit='m²', 
            comment='1_UG_TG_Stü_01 Stützen', 
            source='IN', 
            ka=2, 
            domain='usage', 
            measure='area', 
        ...
        self.GFA_office = VariableMeta(
            ...
            icon='128.60999999999999', 
            label_de='0', 
            unit='m²', 
            comment='1_UG_TG_TW_01 Trennwand zu TG STB 100kg/m³ TG (tragend + Brandschutz)', 
            source='IN', 
            ka=2, 
            domain='usage', 
            measure='area', 
