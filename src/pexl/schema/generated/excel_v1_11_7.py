...
class ExcelNamedVariables:
    def __init__(self):
        ...
        self.popup_infos: object | None = None
        self.popup_warnings: object | None = None
        self.popup_errors: object | None = None
...
class Meta:
    def __init__(self):
        ...
        self.COMP_area_roof_pitched = VariableMeta(
            ...
            unit='m² FU', 
            comment='COMP_area_roof_pitched', 
            source='IN', 
            ka=2, 
            domain='construction', 
            measure='component_fu', 
        ...
        self.popup_infos = VariableMeta(
            var_name='popup_infos', 
            attr_name='popup_infos', 
            icon='🔧', 
            label_de='Popup-Meldung bei Tool Infos', 
            unit='bool', 
            comment=None, 
            source='IN', 
            ka=None, 
            domain='tool', 
            measure='popup_settings', 
            spatial_scope=None, 
            temporal_scope=None, 
            entity_group=None, 
            entity_key=None
        )
        self.popup_warnings = VariableMeta(
            var_name='popup_warnings', 
            attr_name='popup_warnings', 
            icon='🔧', 
            label_de='Popup Fenster bei Tool Warnungen', 
            unit='bool', 
            comment=None, 
            source='IN', 
            ka=None, 
        ...
        self.popup_errors = VariableMeta(
            var_name='popup_errors', 
            attr_name='popup_errors', 
            icon='🔧', 
            label_de='Popup Fenster bei Tool Fehlern', 
            unit='bool', 
            comment=None, 
            source='IN', 
            ka=None, 
...
ATTR_NAME_MAP: dict[str, str] = {
    ...
    'popup_infos': 'popup_infos',
    'popup_warnings': 'popup_warnings',
